...
router.post("/update",auth.checkJWTToken,auth.checkAdmin,invValidate.inventoryRules(),invValidate.checkUpdateData,utilities.handleErrors(invController.updateInventory))
...
router.get("/delete/:inv_id",auth.checkJWTToken,auth.checkAdmin,utilities.handleErrors(invController.buildDeleteInventory))

// Process delete form
router.post("/delete",auth.checkJWTToken,auth.checkAdmin,utilities.handleErrors(invController.deleteInventory))
